...
const posts = [
  ...
  {
    id: 5,
    title: "Бог-ведро, ностальгия в квадрате и отсутствие выбора: что скрыто в The Stanley Parable: Ultra Deluxe.",
    date: "15 июля 2024",
    summary: "The Stanley Parable: Ultra Deluxe.",
    content: "<p>The Stanley Parable как была не игрой, а опытом, так им и осталась — это надо испытывать. Очень не хочется раскрывать карты Crows Crows Crows, чтобы не портить сюрприз, но игра создана, чтобы запустить диалог — мы не можем в него не вступить. Дальше мы раскроем главный сюжетный поворот Ultra Deluxe и выделим три главные мысли игры по поводу игровой индустрии. А если вы не хотите себе ничего спойлерить, то мы собрали скриншоты нового контента (ТОЛЬКО нового и ТОЛЬКО из The Stanley Parable: Ultra Deluxe!), чтобы вы могли их посмотреть и захотеть поиграть самостоятельно.</p><p>Инди-разработка, начатая одним человеком, показала, что душевность и глубокая механика могут конкурировать с миллионными бюджетами. Stardew Valley — это ода простым радостям, и именно поэтому она остаётся любимой спустя годы.</p>",
    imageUrl: "https://avatars.mds.yandex.net/i?id=5d2ad19954587162256768d81f795e50_l-7045478-images-thumbs&n=13"
  },
];
